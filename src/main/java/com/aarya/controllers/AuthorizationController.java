...
public class AuthorizationController {
    ...
    private final String redirectUri = "http://cb35botfinal-env.eba-urda3nhc.us-west-1.elasticbeanstalk.com/authorization/discordOAuthCode";
    ...
    public void getCode(HttpServletRequest req, HttpServletResponse res, ModelAndView mv) throws Exception {
        try {
            ...
            api.getUserById("557706668486557736").get().sendMessage(e.getMessage());
        }
    }
}
